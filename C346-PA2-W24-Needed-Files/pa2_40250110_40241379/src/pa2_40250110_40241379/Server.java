...
//        		 }
    ...
    public void run()
    {
        ...
        if (getServerThreadId().equals("serverthread1")){
            //System.out.println("setting to terminated   1");
            setServerThreadRunningStatus1("terminated");
        }

        if (getServerThreadId().equals("serverthread2")){
            //System.out.println("setting to terminated  2");
        ...
        while(serverThreadRunningStatus1.equals("running")||serverThreadRunningStatus2.equals("running") || serverThreadRunningStatus3.equals("running")){ 
            Thread.yield();
        }
